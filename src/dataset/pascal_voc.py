...
class PascalVOC:
    ...
    def get_graph_pair(self, cls=None, shuffle=True, tgt_outlier=False, src_outlier=False):
        """
    ...
    def get_graph_pair_unbalanced(self, cls=None, shuffle=True):
        """
        Randomly get a pair of objects from VOC-Berkeley keypoints dataset
        :param cls: None for random class, or specify for a certain set
        :param shuffle: random shuffle the keypoints
    ...
    def get_multiple_graphs(self, cls=None, num=2, shuffle=True, filter_outlier=True):
        """
